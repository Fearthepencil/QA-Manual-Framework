...
JQL_QUERY="cf[YOUR_QA_ASSIGNEE_FIELD_ID] = \"$ACCOUNT_ID\" AND project = YOUR_PROJECT ORDER BY updated DESC"
# Use the exact encoding that works (same as PowerShell)
ENCODED_JQL="cf%5BYOUR_QA_ASSIGNEE_FIELD_ID%5D%20%3D%20%22$ACCOUNT_ID%22%20AND%20project%20%3D%20YOUR_PROJECT%20ORDER%20BY%20updated%20DESC"
