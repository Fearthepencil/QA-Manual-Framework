...
JQL_QUERY="cf[11207] = \"$ACCOUNT_ID\" AND project = AP AND status = \"Ready for QA\" ORDER BY updated DESC"
# Use the exact encoding that works (same as PowerShell)
ENCODED_JQL="cf%5B11207%5D%20%3D%20%22$ACCOUNT_ID%22%20AND%20project%20%3D%20AP%20AND%20status%20%3D%20%22Ready%20for%20QA%22%20ORDER%20BY%20updated%20DESC"
